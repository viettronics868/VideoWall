...
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity implements
  ...
  private static final ListEntry[] ENTRIES = {
      new ListEntry("Androidify App", "fdRmGvmeY1U", false),//introduce pronunciation
      new ListEntry("Chrome Speed Tests", "KHllC40_u1Q", false),//long vowel
      //new ListEntry("Playlist: Google I/O 2012", "PL56D792A831D0C362", true)};
      new ListEntry("Playlist: Google I/O 2012", "PLdqmy90rx_N1xp-wiKfYlrO5W3nGxwP0D", true)};//six minute english

...
public final class VideoListDemoActivity extends Activity implements OnFullscreenListener {
  ...
  public static final class VideoListFragment extends ListFragment {
    ...
    static {
      ...
      list.add(new VideoEntry("YouTube Collection", "vC0h4S0YPJc"));
      list.add(new VideoEntry("GMail Tap", "nHSqluHrD-U"));
      list.add(new VideoEntry("Chrome Multitask", "Hb8COxAtl14"));
      list.add(new VideoEntry("Google Fiber", "r1BRCG0P9C8"));
      list.add(new VideoEntry("Autocompleter", "0J7-5maJJIk"));
      list.add(new VideoEntry("GMail Motion", "9WDnVMQIaTs"));
      list.add(new VideoEntry("Translate for Animals", "lFRrEI85IcM"));
